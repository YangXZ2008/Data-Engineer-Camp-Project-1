...
if __name__ == '__main__':
    ...
    data_station, data_fuel = extract(get_token())
    ...
    load(df_exchange=df_station, postgresql_client=get_postgresql_client(),
    ...
    load(df_exchange=df_fuel, postgresql_client=get_postgresql_client(),
